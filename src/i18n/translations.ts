...
export const translations: { [key: string]: Translation } = {
  'pt-BR': {
    ...
    appDescription: 'Calcule todos os materiais necessários para craftar items do mod Refined Storage',
    ...
    selectItemsToSee: 'Selecione alguns items para ver os materiais necessários.',
    ...
    craftingOrder: 'Esta árvore mostra a ordem de crafting: Materiais Base → Intermediários → Item Final',

    // How to Use
    howToUse: 'Como Usar',
    step1Title: 'Selecione Items',
    step1Description: 'Use a busca ou filtros por categoria para encontrar os items que você quer craftar. Ajuste as quantidades conforme necessário.',
    step2Title: 'Veja os Materiais',
    step2Description: 'A calculadora mostra todos os materiais base necessários (ferro, quartzo, etc.) e materiais intermediários que você precisará craftar.',
    step3Title: 'Planeje sua Farm',
    step3Description: 'Use o breakdown detalhado para entender exatamente como os materiais são distribuídos entre os diferentes items.',
  ...
  'en': {
    ...
    appSubtitle: 'Refined Storage',
    appDescription: 'Calculate all materials needed to craft items from the Refined Storage mod',
    ...
    craftingOrder: 'This tree shows the crafting order: Base Materials → Intermediate → Final Item',

    // How to Use
    howToUse: 'How to Use',
    step1Title: 'Select Items',
    step1Description: 'Use search or category filters to find the items you want to craft. Adjust quantities as needed.',
    step2Title: 'View Materials',
    step2Description: 'The calculator shows all required base materials (iron, quartz, etc.) and intermediate materials you need to craft.',
    step3Title: 'Plan Your Farm',
    step3Description: 'Use the detailed breakdown to understand exactly how materials are distributed among different items.',
